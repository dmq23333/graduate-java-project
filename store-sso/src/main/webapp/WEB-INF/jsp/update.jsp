...
<div class="w" id="logo">
    <div>
    	<a href="http://localhost:8082">
    		<img src="/images/taotao-logo.gif" alt="E商城" width="170" height="60"/>
    	</a>
    </div>
</div>
            ...
            <div class="form" onselectstart="return false;">
					...
					<div class="item" id="dphone">
						...
						<div class="fl item-ifo">
							<input type="text" id="phone" maxlength="11" name="phone"
								class="text user-phone" tabindex="4" value="${tbUser.phone}"
                ...
                <div class="item item-new">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《商城用户注册协议》</a></label>
                        <span class="clr"></span>
                ...
                <div class="item">
                    <span class="label">&nbsp;</span>
                    <input type="button" class="btn-img .btn-update" id="registsubmit" value="立即修改" tabindex="8"
...
//设置回显信息
	...
	var REGISTER={
		...
		doSubmit:function() {
			$.post("/user/update",$("#personRegForm").serialize(), function(data){
				if(data.status == 200){
					alert('用户修改信息成功，请登录！');
					REGISTER.login();
				} else {
